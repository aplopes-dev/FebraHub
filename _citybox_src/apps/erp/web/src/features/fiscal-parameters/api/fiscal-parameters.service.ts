...
export async function listFiscalParameters(
  ...
  const response = await comercioFetch<FiscalParameterListResponseDto>(
...
export async function getFiscalParametersByProductId(
  ...
  try {
    const response = await comercioFetch<FiscalParameterDetailResponseDto>(
...
export async function upsertFiscalParameters(
  ...
  const response = await comercioFetch<{
    data: {
      productId: string;
      configured: boolean;
