...
export function SaleOrderFormView({
  ...
  // spec erp/030 (B2) — formas reais (`/v1/payment-methods`), não mais o
  // catálogo mock local: os ids mock vazavam para `SaleOrderPayment.methodId`
  // e bloqueavam a emissão de NF-e ("forma de pagamento desconhecida").
  const paymentMethodsQuery = usePaymentMethodsQuery();
  const paymentMethods = useMemo(
    () => toPaymentMethodOptions(paymentMethodsQuery.data ?? []),
