...
abre a tela de recebimento (uma ou mais formas de pagamento — lista vem do
cadastro em Configurações → Formas de pagamento —, com rateio do valor), e
ao confirmar a OS é marcada como **Concluída** e a venda aparece na tela de
**Vendas**.
