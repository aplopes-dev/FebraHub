...
export async function listStockMovementsApi(
  ...
  const response = await comercioFetch<StockMovementListResponseDto>(
...
export async function getStockMovementByIdApi(id: string): Promise<{
  ...
  const response = await comercioFetch<StockMovementDetailResponseDto>(
...
export async function createStockMovementApi(
  ...
  await comercioFetch<StockMovementCreatedResponseDto>("/v1/stock-movements", {
    method: "POST",
...
export async function listStockBalanceApi(
  ...
  const response = await comercioFetch<StockBalanceListResponseDto>(
...
export async function listProductStockMovementsApi(
  ...
  const response = await comercioFetch<ProductStockMovementsResponseDto>(
...
export async function listMovementCategoryOptionsApi(
  ...
  const response = await comercioFetch<{ data: MovementCategoryOptionDto[] }>(
