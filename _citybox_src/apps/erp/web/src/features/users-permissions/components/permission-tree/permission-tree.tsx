...
import { Checkbox, SearchInput, Typography } from "@citybox/mui";
...
/**
 * Árvore de permissões de uma aba ("Acessos ERP" ou "Acessos PDV") do
 * cadastro de Perfis de Acesso — busca, "selecionar todos" e grupos
 * expansíveis com contadores, no molde da referência ConnectPlug.
 */
