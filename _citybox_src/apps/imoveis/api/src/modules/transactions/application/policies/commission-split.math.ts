...
export function recalculateSplitAmounts(
  ...
  return {
    agencyAmountCents: percentToAmount(
      totalCommissionCents,
      percents.agencyPercent,
    ),
    captorAmountCents: percentToAmount(
      totalCommissionCents,
      percents.captorPercent,
    ),
    sellerAmountCents: percentToAmount(
      totalCommissionCents,
      percents.sellerPercent,
    ),
    others,
    totalCommissionCents,
  };
...
export function buildCommissionSplit(
  ...
  const amounts = recalculateSplitAmounts(
    grossValueCents,
    commissionPercent,
    percents,
  );
