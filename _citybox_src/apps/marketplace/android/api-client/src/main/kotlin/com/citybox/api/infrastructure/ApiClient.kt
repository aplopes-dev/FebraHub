package com.citybox.api.infrastructure

import com.citybox.api.auth.HttpBearerAuth
...
class ApiClient(
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "com.citybox.api.baseUrl"
        @Deprecated(
        ...
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(BASE_URL_KEY, "http://127.0.0.1:4010")
        }
    }
}
