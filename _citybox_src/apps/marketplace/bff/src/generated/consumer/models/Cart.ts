...
export type CartCreateInput = {
  ...
  user: Prisma.ConsumerUserCreateNestedOneWithoutCartInput
...
export type CartUpdateInput = {
  ...
  user?: Prisma.ConsumerUserUpdateOneRequiredWithoutCartNestedInput
...
export type CartOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "couponCode" | "updatedAt", ExtArgs["result"]["cart"]>
...
export interface CartDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Carts and only return the `userId`
   * const cartWithUserIdOnly = await prisma.cart.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Carts and only return the `userId`
   * const cartWithUserIdOnly = await prisma.cart.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
