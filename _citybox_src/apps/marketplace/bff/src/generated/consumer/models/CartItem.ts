...
export type CartItemWhereInput = {
  ...
  cartUserId?: Prisma.StringFilter<"CartItem"> | string
...
export type CartItemWhereUniqueInput = Prisma.AtLeast<{
  cartUserId_productId?: Prisma.CartItemCartUserIdProductIdCompoundUniqueInput
  AND?: Prisma.CartItemWhereInput | Prisma.CartItemWhereInput[]
  OR?: Prisma.CartItemWhereInput[]
  NOT?: Prisma.CartItemWhereInput | Prisma.CartItemWhereInput[]
  cartUserId?: Prisma.StringFilter<"CartItem"> | string
...
export type CartItemScalarWhereWithAggregatesInput = {
  ...
  cartUserId?: Prisma.StringWithAggregatesFilter<"CartItem"> | string
...
export type CartItemUncheckedUpdateInput = {
  cartUserId?: Prisma.StringFieldUpdateOperationsInput | string
...
export type CartItemCartUserIdProductIdCompoundUniqueInput = {
  cartUserId: string
  productId: string
}
...
export type CartItemOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"cartUserId" | "productId" | "quantity", ExtArgs["result"]["cartItem"]>
...
export interface CartItemDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `cartUserId`
   * const cartItemWithCartUserIdOnly = await prisma.cartItem.findMany({ select: { cartUserId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many CartItems and only return the `cartUserId`
   * const cartItemWithCartUserIdOnly = await prisma.cartItem.createManyAndReturn({
   *   select: { cartUserId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more CartItems and only return the `cartUserId`
   * const cartItemWithCartUserIdOnly = await prisma.cartItem.updateManyAndReturn({
   *   select: { cartUserId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface CartItemFieldRefs {
  readonly cartUserId: Prisma.FieldRef<"CartItem", 'String'>
