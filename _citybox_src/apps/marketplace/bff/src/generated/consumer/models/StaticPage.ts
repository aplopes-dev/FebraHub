...
export type StaticPageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"slug" | "title" | "content" | "updatedAt", ExtArgs["result"]["staticPage"]>
...
export interface StaticPageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const staticPageWithSlugOnly = await prisma.staticPage.findMany({ select: { slug: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many StaticPages and only return the `slug`
   * const staticPageWithSlugOnly = await prisma.staticPage.createManyAndReturn({
   *   select: { slug: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more StaticPages and only return the `slug`
   * const staticPageWithSlugOnly = await prisma.staticPage.updateManyAndReturn({
   *   select: { slug: true },
   *   where: {
   *     // ... provide filter here
   *   },
