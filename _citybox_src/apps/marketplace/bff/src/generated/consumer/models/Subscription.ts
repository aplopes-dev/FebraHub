...
export type SubscriptionWhereInput = {
  ...
  priceMonthly?: Prisma.DecimalFilter<"Subscription"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  renewalDate?: Prisma.DateTimeFilter<"Subscription"> | Date | string
  benefits?: Prisma.StringNullableListFilter<"Subscription">
...
export type SubscriptionScalarWhereWithAggregatesInput = {
  ...
  priceMonthly?: Prisma.DecimalWithAggregatesFilter<"Subscription"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  renewalDate?: Prisma.DateTimeWithAggregatesFilter<"Subscription"> | Date | string
  benefits?: Prisma.StringNullableListFilter<"Subscription">
}
...
export type SubscriptionCreateInput = {
  ...
  benefits?: Prisma.SubscriptionCreatebenefitsInput | string[]
  user: Prisma.ConsumerUserCreateNestedOneWithoutSubscriptionInput
}
...
export type SubscriptionUpdateInput = {
  ...
  benefits?: Prisma.SubscriptionUpdatebenefitsInput | string[]
  user?: Prisma.ConsumerUserUpdateOneRequiredWithoutSubscriptionNestedInput
}
...
export type SubscriptionCreatebenefitsInput = {
  set: string[]
}

export type SubscriptionUpdatebenefitsInput = {
  set?: string[]
  push?: string | string[]
}
...
export type SubscriptionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "isActive" | "planName" | "priceMonthly" | "renewalDate" | "benefits", ExtArgs["result"]["subscription"]>
...
export interface SubscriptionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Subscriptions and only return the `userId`
   * const subscriptionWithUserIdOnly = await prisma.subscription.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Subscriptions and only return the `userId`
   * const subscriptionWithUserIdOnly = await prisma.subscription.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface SubscriptionFieldRefs {
  ...
  readonly priceMonthly: Prisma.FieldRef<"Subscription", 'Decimal'>
  readonly renewalDate: Prisma.FieldRef<"Subscription", 'DateTime'>
  readonly benefits: Prisma.FieldRef<"Subscription", 'String[]'>
}
