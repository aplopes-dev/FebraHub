...
[**cancelOrder**](PedidosAPI.md#cancelorder) | **POST** /me/orders/{orderId}/cancel | Cancelar pedido (D1/D4)
[**createReturn**](PedidosAPI.md#createreturn) | **POST** /me/orders/{orderId}/returns | Solicitar devolução (D4)
...
// Comprar novamente (D1)
PedidosAPI.buyAgain(orderId: orderId) { (response, error) in
...
// Cancelar pedido (D1/D4)
PedidosAPI.cancelOrder(orderId: orderId, cancelOrderRequest: cancelOrderRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Solicitar devolução (D4)
PedidosAPI.createReturn(orderId: orderId, createReturnRequest: createReturnRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Nota fiscal (D1)
PedidosAPI.getInvoice(orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Detalhe do pedido (D1)
PedidosAPI.getOrder(orderId: orderId, ifNoneMatch: ifNoneMatch) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Consultar devolução (D4)
PedidosAPI.getReturn(orderId: orderId, returnId: returnId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Rastreamento (D2)
PedidosAPI.getTracking(orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Listar pedidos
PedidosAPI.listOrders(page: page, pageSize: pageSize, status: status) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
