...
// Excluir conta (B6)
PerfilAPI.deleteAccount(deleteAccountRequest: deleteAccountRequest) { (response, error) in
...
// Obter perfil (B1)
PerfilAPI.getMe() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Obter configurações (B6)
PerfilAPI.getSettings() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Editar perfil (B1)
PerfilAPI.updateMe(updateMeRequest: updateMeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Atualizar configurações (B6)
PerfilAPI.updateSettings(settings: settings) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Upload de avatar (B1)
PerfilAPI.uploadAvatar(file: file) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
