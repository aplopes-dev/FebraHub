...
| [**addSearchHistory**](CatlogoDescobertaApi.md#addsearchhistoryoperation) | **POST** /me/search-history | Registrar busca (E4) |
| [**clearSearchHistory**](CatlogoDescobertaApi.md#clearsearchhistory) | **DELETE** /me/search-history | Limpar histórico (E4) |
| [**createReview**](CatlogoDescobertaApi.md#createreviewoperation) | **POST** /catalog/products/{productId}/reviews | Escrever avaliação (D3) |
...
async function example() {
  ...
  const api = new CatlogoDescobertaApi(config);
...
async function example() {
  console.log("🚀 Testing @citybox/api-client SDK...");
  const api = new CatlogoDescobertaApi();
