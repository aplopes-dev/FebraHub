...
| [**cancelOrder**](PedidosPsCompraApi.md#cancelorderoperation) | **POST** /me/orders/{orderId}/cancel | Cancelar pedido (D1/D4) |
| [**createReturn**](PedidosPsCompraApi.md#createreturnoperation) | **POST** /me/orders/{orderId}/returns | Solicitar devolução (D4) |
...
async function example() {
  ...
  const api = new PedidosPsCompraApi(config);
