...
|------------- | ------------- | -------------|
| [**deleteAccount**](PerfilContaApi.md#deleteaccountoperation) | **DELETE** /me | Excluir conta (B6) |
...
| [**updateMe**](PerfilContaApi.md#updatemeoperation) | **PATCH** /me | Editar perfil (B1) |
...
async function example() {
  ...
  const api = new PerfilContaApi(config);
