...
/**
 * Stepper vendorizado no lugar de `@/components/ui/stepper` do OdontoTech
 * (não existe no @citybox/ui). Mantém a mesma API pública. A variante
 * `StepperTrigger asChild` foi removida por não ser usada na feature e para
 * evitar a dependência do `Slot` da radix, ausente no ERP.
 */
...
function StepperTrigger({
  ...
  if (asChild) {
    return (
      <span className={className} data-slot="stepper-trigger">
        {children}
      </span>
    );
  }
