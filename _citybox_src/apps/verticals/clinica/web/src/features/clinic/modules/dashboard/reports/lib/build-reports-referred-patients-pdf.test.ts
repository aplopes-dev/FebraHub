...
} from './build-reports-referred-patients-pdf';

const SAMPLE_ROWS: ReportReferredPatientRow[] = [
  {
    id: 'p1',
    referredPatientName: 'Ana Carolina Silva',
    referredBy: 'Não informado',
    referralDate: '2026-07-18',
...
describe('buildReportsReferredPatientsPdf', () => {
  it('builds pdf blob with clinic header and file name', async () => {
    ...
    expect(buildReportsReferredPatientsPdfFileName(generatedAt)).toContain(
      'relatorio-pacientes-indicados',
    );
  });
