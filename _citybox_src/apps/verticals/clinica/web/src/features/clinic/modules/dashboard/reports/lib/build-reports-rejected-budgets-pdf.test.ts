...
} from './build-reports-rejected-budgets-pdf';
...
describe('buildReportsRejectedBudgetsPdf', () => {
  it('builds pdf blob with clinic header and file name', async () => {
    ...
    expect(buildReportsRejectedBudgetsPdfFileName(generatedAt)).toContain(
      'relatorio-orcamentos-reprovados',
    );
  });
