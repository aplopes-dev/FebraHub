...
} from './build-reports-sales-by-professional-pdf';

const SAMPLE_ROWS: ReportSalesByProfessionalRow[] = [
  {
    id: 'i1',
...
describe('buildReportsSalesByProfessionalPdf', () => {
  it('builds pdf blob with clinic header and file name', async () => {
    ...
    expect(buildReportsSalesByProfessionalPdfFileName(generatedAt)).toContain(
      'relatorio-vendas-por-profissional',
    );
  });
