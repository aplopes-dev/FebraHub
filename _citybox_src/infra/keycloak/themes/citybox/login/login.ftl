...
<!-- template: login.ftl (aplopes) -->

    <#if section = "header">
        <div class="citybox-card-head">
            <span class="citybox-card-icon" aria-hidden="true">AP</span>
            <div class="citybox-card-head-text">
                <span class="citybox-card-brand">${realm.displayName!'Citybox Platform'}</span>
                <span class="citybox-card-sub">${msg("loginAccountTitle")}</span>
            </div>
        </div>
    <#elseif section = "form">
        <div id="kc-form">
