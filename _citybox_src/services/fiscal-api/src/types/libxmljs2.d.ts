...
/// registro npm — declaração mínima cobrindo só a superfície usada por
/// `shared/infra/fiscal-xml/xsd-validator.ts` (validação XSD via libxml2 nativo).
declare module 'libxmljs2' {
  ...
  /// Cobre só a superfície usada por `fiscal-soap/nfe-soap-response.ts` para
  /// extrair o XML bruto embutido dentro de um wrapper genérico
  /// (`nfeResultMsg`) de uma resposta SOAP da SEFAZ.
