...
(function () {
  ...
  const NAV_GROUPS = [
    {
      id: 'intro',
      label: 'Introdução',
      items: ['visao-geral', 'benchmark-mercado', 'mapa-mental', 'arquitetura', 'glossario']
    },
    {
      id: 'acesso',
      label: 'Acesso, Perfis e Permissões',
      items: ['autenticacao-perfis', 'rbac-permissoes', 'suporte-impersonation']
    },
    {
      id: 'visao',
      label: 'Visão Geral',
    ...
    },
    {
      id: 'clientes',
      label: 'Clientes',
      items: ['clientes', 'cliente-detalhe', 'saude-churn', 'onboarding-jornada']
    },
    {
      id: 'lojas',
      label: 'Lojas',
      items: ['lojas', 'loja-detalhe', 'equipe-loja', 'monitoramento-lojas', 'integracoes']
    },
    {
      id: 'equipe',
      label: 'Equipe Citybox',
      items: ['usuarios']
    },
    {
      id: 'financeiro',
      label: 'Planos e Financeiro',
      items: ['planos', 'financeiro', 'faturamento-cobranca']
    },
    {
      id: 'plataforma',
      label: 'Plataforma',
      items: ['configuracoes-plataforma', 'notificacoes-comunicados', 'relatorios-exportacoes']
    },
    {
      id: 'compliance',
      label: 'Compliance',
  ...
  var FEEDBACK_KEY = 'wiki_admin_feedback';
  ...
  function initExport() {
    document.addEventListener('click', function (e) {
      if (e.target && e.target.id === 'exportFeedbackBtn') {
        var all  = getAllFeedback();
        var text = 'RELATÓRIO DE APROVAÇÃO — Wiki Admin Citybox\n';
