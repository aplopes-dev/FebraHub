...
<div class="section-header">
  ...
  <p class="section-subtitle">Este wiki é um blueprint de desenvolvimento. Use os botões em cada seção para aprovar o conteúdo ou solicitar ajustes. Esta seção mostra o progresso geral.</p>
  <div class="section-tags">
    <span class="tag-teal">Revisão</span>
    <span class="tag-gray">27 seções para revisar</span>
  </div>
</div>
...
<div class="card-grid">
  <div class="card card-teal">
    ...
    <p>Navegue pelo menu lateral e leia o conteúdo de cada seção. Verifique os blocos "Hoje (MVP)" e "Proposta (alvo)".</p>
  </div>
  <div class="card card-teal">
...
<div class="table-wrap">
  <table>
    ...
    <tbody>
      <tr><td class="td-bold">Introdução</td><td>Visão Geral, Benchmark, Mapa Mental, Arquitetura, Glossário</td><td>Ver badges no menu →</td></tr>
      <tr><td class="td-bold">Acesso e Permissões</td><td>Autenticação, RBAC, Impersonation</td><td>Ver badges no menu →</td></tr>
      <tr><td class="td-bold">Visão Geral</td><td>Dashboard</td><td>Ver badges no menu →</td></tr>
      <tr><td class="td-bold">Clientes</td><td>Clientes, Detalhe, Saúde/Churn, Onboarding</td><td>Ver badges no menu →</td></tr>
      <tr><td class="td-bold">Lojas</td><td>Lojas, Detalhe, Equipe, Monitoramento, Integrações</td><td>Ver badges no menu →</td></tr>
      <tr><td class="td-bold">Equipe Citybox</td><td>Usuários</td><td>Ver badges no menu →</td></tr>
      <tr><td class="td-bold">Planos e Financeiro</td><td>Planos, Financeiro, Faturamento e Cobrança</td><td>Ver badges no menu →</td></tr>
      <tr><td class="td-bold">Plataforma</td><td>Configurações, Notificações, Relatórios</td><td>Ver badges no menu →</td></tr>
      <tr><td class="td-bold">Compliance</td><td>Auditoria</td><td>Ver badges no menu →</td></tr>
      <tr><td class="td-bold">Evolução</td><td>Roadmap</td><td>Ver badges no menu →</td></tr>
    </tbody>
  </table>
</div>
