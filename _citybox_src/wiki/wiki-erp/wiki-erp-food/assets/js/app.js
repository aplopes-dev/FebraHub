...
(function () {
  ...
  var FEEDBACK_KEY = 'wiki_erp_food_feedback';

  const NAV_GROUPS = [
    {
      id: 'intro',
      label: 'Introdução',
      items: ['visao-geral-food', 'estado-implementacao-food', 'benchmark-food', 'jornada-restaurante']
    },
    {
      id: 'cardapio',
      label: 'Cardápio e Estoque',
      items: ['cardapio-modificadores', 'fichas-tecnicas', 'estoque-insumos']
    },
    {
      id: 'operacao-salao',
      label: 'Operação de Salão / PDV',
      items: ['salao-mesas-comandas', 'pdv-food']
    },
    {
      id: 'cozinha',
      label: 'Cozinha e KDS',
    ...
    {
      id: 'pedidos',
      label: 'Pedidos e Delivery',
      items: ['pedidos-canais', 'delivery-integracoes']
    },
    {
      id: 'fiscal-fin',
      label: 'Fiscal e Financeiro',
      items: ['fiscal-food', 'financeiro-cmv']
    },
    {
      id: 'clientes-mkt',
      label: 'Clientes e Marketplace',
      items: ['crm-fidelidade-food', 'marketplace-food']
    },
    {
      id: 'acesso-config',
      label: 'Acesso e Configurações',
      items: ['rbac-equipe-food', 'configuracoes-food']
    },
    {
      id: 'analytics-evolucao',
      label: 'Analytics e Evolução',
      items: ['relatorios-food', 'roadmap-food', 'como-aprovar-food']
    }
  ];
  ...
  function updateProgress() {
    var all = getAllFeedback();
    var excludeIds = ['como-aprovar-food'];
  ...
  function renderFeedbackWidget(sectionId) {
    if (sectionId === 'como-aprovar-food') return '';
  ...
  function renderSection(section) {
    ...
    if (section.id === 'como-aprovar-food') { populateApprovalSummary(); }
  }
  ...
  function populateApprovalSummary() {
    ...
    WIKI.sections.forEach(function (s) {
      if (s.id === 'como-aprovar-food') return;
  ...
  function initExport() {
    document.addEventListener('click', function (e) {
      if (e.target && e.target.id === 'exportFeedbackBtn') {
        var all  = getAllFeedback();
        var text = 'RELATÓRIO DE APROVAÇÃO — Wiki ERP Food Citybox\n';
