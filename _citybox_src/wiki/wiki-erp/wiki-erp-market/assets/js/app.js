...
(function () {
  ...
  var FEEDBACK_KEY = 'wiki_erp_market_feedback';

  const NAV_GROUPS = [
    {
      id: 'intro',
      label: 'Introdução',
      items: ['visao-geral-market', 'benchmark-market', 'jornada-varejo']
    },
    {
      id: 'catalogo-preco',
      label: 'Catálogo e Preço',
      items: ['catalogo-produtos', 'balanca-granel', 'precificacao-promocoes']
    },
    {
      id: 'frente-caixa',
      label: 'Frente de Caixa',
      items: ['pdv-frente-caixa']
    },
    {
      id: 'estoque-suprimento',
      label: 'Estoque e Suprimento',
      items: ['estoque-validade-lotes', 'recebimento-mercadorias', 'compras-fornecedores']
    },
    {
      id: 'pedidos-canais',
      label: 'Pedidos e Canais',
      items: ['pedidos-canais-market']
    },
    {
      id: 'fiscal-fin',
      label: 'Fiscal e Financeiro',
      items: ['fiscal-market', 'financeiro-varejo']
    },
    {
      id: 'clientes-mkt',
      label: 'Clientes e Marketplace',
      items: ['crm-fidelidade-market', 'marketplace-market']
    },
    {
      id: 'acesso-config',
      label: 'Acesso e Configurações',
      items: ['rbac-equipe-market', 'configuracoes-market']
    },
    {
      id: 'analytics-evolucao',
      label: 'Analytics e Evolução',
      items: ['relatorios-market', 'roadmap-market', 'como-aprovar-market']
    }
  ];
  ...
  function updateProgress() {
    var all = getAllFeedback();
    var excludeIds = ['como-aprovar-market'];
  ...
  function renderFeedbackWidget(sectionId) {
    if (sectionId === 'como-aprovar-market') return '';
  ...
  function renderSection(section) {
    ...
    if (section.id === 'como-aprovar-market') { populateApprovalSummary(); }
  }
  ...
  function populateApprovalSummary() {
    ...
    WIKI.sections.forEach(function (s) {
      if (s.id === 'como-aprovar-market') return;
  ...
  function initExport() {
    document.addEventListener('click', function (e) {
      if (e.target && e.target.id === 'exportFeedbackBtn') {
        var all  = getAllFeedback();
        var text = 'RELATÓRIO DE APROVAÇÃO — Wiki ERP Market Citybox\n';
