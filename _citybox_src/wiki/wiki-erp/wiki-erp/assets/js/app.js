/* ============================================================
   Wiki ERP Base Citybox — App Core
...
(function () {
  ...
  var FEEDBACK_KEY = 'wiki_erp_feedback';

  const NAV_GROUPS = [
    {
      id: 'intro',
      label: 'Introdução',
      items: ['visao-geral', 'benchmark-erp', 'mapa-mental', 'arquitetura', 'glossario']
    },
    {
      id: 'plataforma',
      label: 'Plataforma e Shell',
      items: ['multi-vertical', 'autenticacao-sso', 'selecao-troca-loja', 'navegacao-layout', 'configuracoes-loja']
    },
    {
      id: 'visao-dia',
      label: 'Visão do Dia',
    ...
    },
    {
      ...
      items: ['rbac-permissoes', 'equipe-loja']
    },
    {
      id: 'catalogo',
      label: 'Catálogo e Operação',
      items: ['catalogo', 'pedidos', 'checkout-carrinho', 'pdv-caixa', 'estoque', 'entrega-frete', 'agenda-slots']
    },
    {
      id: 'clientes',
      label: 'Clientes e Engajamento',
      items: ['clientes-crm', 'notificacoes-comunicados']
    },
    {
      id: 'financeiro',
      label: 'Financeiro e Fiscal',
      items: ['pagamentos-repasse', 'fiscal', 'financeiro', 'contas-pagar', 'contas-receber', 'fluxo-caixa', 'conciliacao-bancaria']
    },
    {
      id: 'analytics',
      label: 'Analytics',
      items: ['relatorios-analytics']
    },
    {
      id: 'compras',
      label: 'Compras e Fidelidade',
      items: ['compras-fornecedores', 'fidelidade']
    },
    {
      id: 'devices',
      label: 'Devices e Realtime',
      items: ['devices', 'realtime-sync']
    },
    {
      id: 'marketplace',
      label: 'Marketplace',
      items: ['marketplace-publish']
    },
    {
      id: 'evolucao',
      label: 'Evolução',
      items: ['roadmap-evolucao', 'como-aprovar']
    }
  ];
  ...
  function initExport() {
    document.addEventListener('click', function (e) {
      if (e.target && e.target.id === 'exportFeedbackBtn') {
        var all  = getAllFeedback();
        var text = 'RELATÓRIO DE APROVAÇÃO — Wiki ERP Base Citybox\n';
