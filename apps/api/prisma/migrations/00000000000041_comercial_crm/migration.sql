...
VALUES
  ('m0000001-0000-4000-8000-000000000001', 'Preço',                  true, 1),
  ('m0000001-0000-4000-8000-000000000002', 'Sem interesse',           true, 2),
  ('m0000001-0000-4000-8000-000000000003', 'Momento inadequado',      true, 3),
  ('m0000001-0000-4000-8000-000000000004', 'Não respondeu',           true, 4),
  ('m0000001-0000-4000-8000-000000000005', 'Concorrente',             true, 5),
  ('m0000001-0000-4000-8000-000000000006', 'Sem orçamento',           true, 6),
  ('m0000001-0000-4000-8000-000000000007', 'Produto inadequado',      true, 7),
  ('m0000001-0000-4000-8000-000000000008', 'Duplicidade',             true, 8),
  ('m0000001-0000-4000-8000-000000000009', 'Outro',                   true, 9)
ON CONFLICT (id) DO NOTHING;
