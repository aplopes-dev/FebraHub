...
import { ArrowLeft, KeyRound, ChefHat, ShoppingCart, ListOrdered, Receipt } from "lucide-react";
...
const TABS = [
  ...
  { href: "/pdv-movel/retirada", label: "Preparar", Icone: ChefHat },
  { href: "/pdv-movel/codigo", label: "Código", Icone: KeyRound },
];

export default function ShellPdvMovel({ children }: { children: ReactNode }) {
  ...
  // Marca o <html> enquanto o PDV móvel está montado. Serve de gancho para o
  // CSS que trava scroll/zoom/rubber-band do documento inteiro (o app é uma
  // casca fixa — quem rola é só a .pm-main). Restaura ao sair.
  useEffect(() => {
    const html = document.documentElement;
    html.classList.add("pm-root");
    return () => { html.classList.remove("pm-root"); };
  }, []);
