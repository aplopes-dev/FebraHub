...
type AddressSectionProps = {
  address: UnitAddress;
  onChange: <Key extends keyof UnitAddress>(
    key: Key,
    value: UnitAddress[Key],
  ) => void;
  onPatch: (partial: Partial<UnitAddress>) => void;
  /** Troca ao recarregar o cadastro — evita lookup automático do CEP já salvo. */
