...
const CHANNEL_OPTIONS = PRODUCT_FILTER_CHANNEL_OPTIONS.map((channel) => ({
  value: channel.id,
  label: channel.name,
}));
...
export function PriceListForm({
  ...
  const [branchIds, setBranchIds] = useState<string[]>(initialValues.branchIds);
    ...
    >
      ...
      <Box>
        ...
        <Typography
          ...
          sx={{ color: "text.secondary", mt: 0.5, display: "block" }}
        >
          Vazio = a lista vale em todas as unidades.
        </Typography>
      </Box>
