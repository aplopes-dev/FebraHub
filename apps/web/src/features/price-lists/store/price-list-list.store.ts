...
export const usePriceListListStore = create<PriceListListState>((set) => ({
  search: "",
  debouncedSearch: "",
  page: 1,
...
export function selectPriceListListParams(
  state: PriceListListState,
): PriceListListParams {
  return {
