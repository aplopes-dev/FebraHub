...
export async function listProductionOrdersApi(
  ...
  const response = await apiFetch<ProductionOrderListResponseDto>(
...
export async function getProductionOrderApi(
  ...
  const response = await apiFetch<ProductionOrderDetailResponseDto>(
...
export async function createProductionOrderApi(
  ...
  await apiFetch<ProductionOrderSingleResponseDto>(
...
export async function listProductionHistoryApi(
  ...
  const response = await apiFetch<ProductionHistoryListResponseDto>(
...
export async function addProductionHistoryCommentApi(
  ...
  const entry = await apiFetch<ProductionHistoryEntryDto>(
    `/v1/production-orders/${orderId}/history`,
    { method: "POST", body: JSON.stringify(payload) },
  );
