...
export function productDtoToFormValues(
  ...
  return {
    ...
    availability: {
      ...
      availableOnPdv:
        dto.type === "supply" ? false : (dto.availableOnPdv ?? true),
    },
...
function mapAddonLinesToForm(lines: ProductAddonLineDto[]): ProductAddonRow[] {
  ...
  return lines
    ...
    .map((line) => ({
      ...
      addonProductId: line.addonProductId,
...
export function formValuesToPayload(
  ...
  return {
    ...
    // Imagem sobe por POST/DELETE `/v1/products/:id/image` — omitir no PUT.
    ...
    availableOnPdv:
      values.type === "supply" ? false : values.availability.availableOnPdv,
  };
}
