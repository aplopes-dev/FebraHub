...
export function ContractStatusSortableRow({
  status,
  onEdit,
  onDelete,
}: ContractStatusSortableRowProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
