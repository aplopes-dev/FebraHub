    ...
    >
      ...
      >
        ...
        <FormField
          ...
          value={formatPhone(value.commercialPhone)}
          placeholder="(00) 00000-0000"
          onChange={(event) =>
            set({ commercialPhone: formatPhone(event.target.value) })
          }
        />
        <FormField
          id="sup-mobile-phone"
          label="Celular"
          value={formatPhone(value.mobilePhone)}
          placeholder="(00) 00000-0000"
          onChange={(event) =>
            set({ mobilePhone: formatPhone(event.target.value) })
          }
        />
      </Box>
    </SupplierSection>
