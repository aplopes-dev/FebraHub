...
import { Autocomplete, Button, Checkbox, CurrencyInput, NumberInput } from "@/ui";
...
export function ComponentSortableRow({
  ...
  return (
    ...
    >
      ...
      <Box sx={{ width: compositionCol.unitCost, flexShrink: 0, display: { xs: "none", md: "block" }, ml: 0.5 }}>
        <CurrencyInput
          value={row.unitCost}
