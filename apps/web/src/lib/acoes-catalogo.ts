...
const acoes_loja: Acao[] = [
  ...
  {
    id: "loja-omie-config",
    label: "Configurar Omie",
    desc: "Chaves de API, conta corrente e sincronizar SKU de produtos",
    keywords: ["omie", "sku", "sincronizar", "integração", "erp", "configurar", "api key"],
    href: "/loja/vendas",
    icone: "Link2",
    grupo: "loja",
  ...
  },
  {
    ...
    desc: "Metas mensais, metas por curso e fechamento do mês",
    keywords: ["meta", "mensal", "objetivo", "planejamento", "fechamento", "curso"],
