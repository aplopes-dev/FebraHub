            ...
            leaves: [
              {
                ...
                path: "/comercial",
                icon: "reports",
                description: "Pódio, placar da semana e conversão.",
                disabled: true,
              },
              {
                id: "comercial-funil",
                ...
                icon: "pipeline",
                description: "Oportunidades por etapa, em kanban ou lista.",
                disabled: true,
              },
              {
                id: "comercial-vendas",
                ...
                path: "/vendas",
                icon: "sales",
                description: "Vendas fechadas, aprovação e cancelamento.",
              },
              {
          ...
          },
          {
            ...
            leaves: [
              ...
              },
              {
                ...
                icon: "zap",
                description: "Captação recente e origem de cada contato.",
                disabled: true,
              },
            ],
          },
          {
            ...
            leaves: [
              ...
              },
              {
                ...
                icon: "calendar",
                description: "Palestras e workshops — pedidos e participantes.",
                disabled: true,
              },
            ],
          },
