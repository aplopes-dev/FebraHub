...
const LAYER_META: { kind: NeuralLayerKind; name: string }[] = [
  { kind: 'tool', name: 'ENTRADA · FERRAMENTAS' },
  { kind: 'worker', name: 'CAMADA 1 · EQUIPE' },
  { kind: 'task', name: 'CAMADA 2 · FUNÇÕES' },
  { kind: 'team', name: 'CAMADA 3 · SETORES' },
  { kind: 'self', name: 'SAÍDA · NÚCLEO' },
];
