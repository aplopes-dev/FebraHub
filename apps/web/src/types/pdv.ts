...
export interface PdvProduto { produtoId: string; codigo?: string | null; descricao?: string | null; preco: number; saldo: number; reservado: number; disponivel: number; categoria?: string | null; imagemUrl?: string | null; precisaPreparacao?: boolean; controlaEstoque?: boolean; vendeSemEstoque?: boolean; sku?: string | null; emDestaque?: boolean }
